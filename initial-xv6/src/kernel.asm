...
801058ee:	00 00 ef 
  initlock(&tickslock, "time");
801058f1:	68 7d 78 10 80       	push   $0x8010787d
...
80105974:	3e ff 24 85 24 79 10 	notrack jmp *-0x7fef86dc(,%eax,4)
8010597b:	80 
    lapiceoi();
    break;
...
801059d1:	68 e0 78 10 80       	push   $0x801078e0
...
80105aec:	68 88 78 10 80       	push   $0x80107888
...
80105b88:	68 ac 78 10 80       	push   $0x801078ac
80105b8d:	e8 1e ab ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105b92:	83 c4 14             	add    $0x14,%esp
80105b95:	68 82 78 10 80       	push   $0x80107882
...
80105c93:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80105c98:	bb a4 79 10 80       	mov    $0x801079a4,%ebx
  ioapicenable(IRQ_COM1, 0);
...
8010689d:	68 ac 79 10 80       	push   $0x801079ac
...
80106953:	68 66 73 10 80       	push   $0x80107366
...
80106b8f:	68 f1 79 10 80       	push   $0x801079f1
...
80106cf9:	68 29 7a 10 80       	push   $0x80107a29
...
80106d5b:	68 41 7a 10 80       	push   $0x80107a41
...
80106e3c:	68 5d 7a 10 80       	push   $0x80107a5d
...
80106f13:	68 6e 7a 10 80       	push   $0x80107a6e
...
80106ff9:	68 92 7a 10 80       	push   $0x80107a92
80106ffe:	e8 8d 93 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80107003:	83 ec 0c             	sub    $0xc,%esp
80107006:	68 78 7a 10 80       	push   $0x80107a78
...
801070e0 <sys_getreadcount>:
int sys_getreadcount(void) {
801070e0:	f3 0f 1e fb          	endbr32 
    return 0;
}
801070e4:	31 c0                	xor    %eax,%eax
801070e6:	c3                   	ret    
